...
class RoomTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_type" do
    assert_difference('RoomType.count') do
      post room_types_url, params: { room_type: { description: @room_type.description, name: @room_type.name, price: @room_type.price } }
    end
  ...
  test "should update room_type" do
    patch room_type_url(@room_type), params: { room_type: { description: @room_type.description, name: @room_type.name, price: @room_type.price } }
